...
#define user "/AqLpHjsI2"
#define firebasePath "/AqLpHjsI2/powers/P_"
...
void setup()
{
  ...
  digitalWrite(pinArray[0],   0);
    delay(200);
    digitalWrite(pinArray[1], 0);
    delay(200);
...
void loop()
{  
if (millis() - schprv > 60000 || schprv == 0){ 
schprv  = millis(); 
handleOffSch();}
if (millis() - PrevMillis > 1000 || PrevMillis == 0) {
  PrevMillis = millis();
