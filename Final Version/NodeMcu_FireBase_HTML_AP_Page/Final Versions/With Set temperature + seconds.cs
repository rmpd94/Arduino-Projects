...
String user = String( "/AqLFCshkI"); 
String firebasePath= String ("/powers/P_");
...
String Temp;
  ...
  Firebase.setString(firebaseData, user + "/TM",Temp );
     ...
     if(Firebase.get(firebaseData, user + "/schedules"))
    {
     ...
     JsonObject& root = jsonBuffer.parseObject(jsonStr);
       Sch1 = (const char*)root["S01"]; 
       Sch2 = (const char*)root["S02"];  
       Sch3 = (const char*)root["S03"]; 
       Sch4 = (const char*)root["S04"]; 
       Sch5 = (const char*)root["S05"]; 
       Sch6 = (const char*)root["S06"]; 
       Sch7 = (const char*)root["S07"]; 
       Sch8 = (const char*)root["S08"]; 
       Sch9 = (const char*)root["S09"];
       Sch10 = (const char*)root["S10"];
       Sch11 = (const char*)root["S11"];
       Sch12 = (const char*)root["S12"];
       SSch = (const char*)root["SS"];
    ...
    if (NPMH == Sch1.substring(4,6) && NPMM == Sch1.substring(7,9) && (Sch1.substring(13).indexOf(NPWD) >= 0 || Sch1.substring(13).indexOf("7") >= 0)    ){
		
      if (Sch1.substring(10,12) != "--"){handleMilis( Sch1.substring(0,1), Sch1.substring(10,12));
	  } else{
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch2.substring(4,6) && NPMM == Sch2.substring(7,9) && (Sch2.substring(13).indexOf(NPWD) >= 0 || Sch2.substring(13).indexOf("7") >= 0)     ){
      if (Sch2.substring(10,12) != "--"){handleMilis( Sch2.substring(0,1), Sch2.substring(10,12));
	  } else{ 
    ...
    //-----------------------------------
    if (NPMH == Sch3.substring(4,6) && NPMM == Sch3.substring(7,9)&& (Sch3.substring(13).indexOf(NPWD) >= 0 || Sch3.substring(13).indexOf("7") >= 0)   ){
       if (Sch3.substring(10,12) != "--"){handleMilis( Sch3.substring(0,1), Sch3.substring(10,12));
	  } else{
    ...
    //-----------------------------------
    if (NPMH == Sch4.substring(4,6) && NPMM == Sch4.substring(7,9) && (Sch4.substring(13).indexOf(NPWD) >= 0 || Sch4.substring(13).indexOf("7") >= 0)    ){
       if (Sch4.substring(10,12) != "--"){handleMilis( Sch4.substring(0,1), Sch4.substring(10,12));
	  } else{
    ...
    if (NPMH == Sch5.substring(4,6) && NPMM == Sch5.substring(7,9) && (Sch5.substring(13).indexOf(NPWD) >= 0 || Sch5.substring(13).indexOf("7") >= 0)   ){
       if (Sch5.substring(10,12) != "--"){handleMilis( Sch5.substring(0,1), Sch5.substring(10,12));
	  } else{
    ...
    //-----------------------------------
    if (NPMH == Sch6.substring(4,6) && NPMM == Sch6.substring(7,9) && (Sch6.substring(13).indexOf(NPWD) >= 0 || Sch6.substring(13).indexOf("7") >= 0)    ){
       if (Sch6.substring(10,12) != "--"){handleMilis( Sch6.substring(0,1), Sch6.substring(10,12));
	  } else{
    ...
    if (NPMH == Sch7.substring(4,6) && NPMM == Sch7.substring(7,9) && (Sch7.substring(13).indexOf(NPWD) >= 0 || Sch7.substring(13).indexOf("7") >= 0)    ){
       if (Sch7.substring(10,12) != "--"){handleMilis( Sch7.substring(0,1), Sch7.substring(10,12));
	  } else{
    ...
    if (NPMH == Sch8.substring(4,6) && NPMM == Sch8.substring(7,9) && (Sch8.substring(13).indexOf(NPWD) >= 0 || Sch8.substring(13).indexOf("7") >= 0)     ){
       if (Sch8.substring(10,12) != "--"){handleMilis( Sch8.substring(0,1), Sch8.substring(10,12));
	  } else{
    ...
    if (NPMH == Sch9.substring(4,6) && NPMM == Sch9.substring(7,9) && (Sch9.substring(13).indexOf(NPWD) >= 0 || Sch9.substring(13).indexOf("7") >= 0)    ){
       if (Sch9.substring(10,12) != "--"){handleMilis( Sch9.substring(0,1), Sch9.substring(10,12));
	  } else{
 ...
 //-----------------------------------
    ...
    if (NPMH == Sch10.substring(4,6) && NPMM == Sch10.substring(7,9) && (Sch10.substring(13).indexOf(NPWD) >= 0 || Sch10.substring(13).indexOf("7") >= 0)     ){
       if (Sch10.substring(10,12) != "--"){handleMilis( Sch10.substring(0,1), Sch10.substring(10,12));
	  } else{
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch11.substring(4,6) && NPMM == Sch11.substring(7,9) && (Sch11.substring(13).indexOf(NPWD) >= 0 || Sch11.substring(13).indexOf("7") >= 0)    ){
       if (Sch11.substring(10,12) != "--"){handleMilis( Sch11.substring(0,1), Sch11.substring(10,12));
	  } else{
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch12.substring(4,6) && NPMM == Sch12.substring(7,9) && (Sch12.substring(13).indexOf(NPWD) >= 0 || Sch12.substring(13).indexOf("7") >= 0)     ){
       if (Sch12.substring(10,12) != "--"){handleMilis( Sch12.substring(0,1), Sch12.substring(10,12));
	  } else{
...
{ 
  ...
  return;
     ...
     String jsonStr;
     json.toString(jsonStr,true);
     DynamicJsonBuffer jsonBuffer(740);
     JsonObject& root = jsonBuffer.parseObject(jsonStr);
