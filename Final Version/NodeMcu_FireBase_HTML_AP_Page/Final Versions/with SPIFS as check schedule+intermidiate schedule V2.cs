...
#define user "/AqLgpfJRm"
#define firebasePath "/AqLgpfJRm/powers/P_"
...
void checkScheduleOld(String sch, String hh, String mn, String dy)
{  
...
void checkScheduleNew(String scharr[], String hh, String mn, String dy) {
  ...
  for (int p = 0; p < 4; p++) {//for each powerpoint
      prevscheduleint = 0;
