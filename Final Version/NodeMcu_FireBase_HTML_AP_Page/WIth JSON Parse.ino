...
{ 
 ...
 // struct tm* p_tm = localtime(&now);
    ...
    NPMM = p_tm->tm_min;
    NPMD = p_tm->tm_mday;
	NPWD = p_tm->tm_wday ;  //( Starting from sunday as 0 to 6 as saturday)
    ...
    if (NPMH == Sch1.substring(4,6) && NPMM == Sch1.substring(7,9) && Sch1.substring(9).indexOf(NPWD) >= 0 &&NTPUNIQUE != S1UNIQUE  ){
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch2.substring(4,6) && NPMM == Sch2.substring(7,9)&& Sch2.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S2UNIQUE  ){
    ...
    //-----------------------------------
    if (NPMH == Sch3.substring(4,6) && NPMM == Sch3.substring(7,9)&& Sch3.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S3UNIQUE  ){
    ...
    //-----------------------------------
    if (NPMH == Sch4.substring(4,6) && NPMM == Sch4.substring(7,9) && Sch4.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S4UNIQUE  ){
    ...
    if (NPMH == Sch5.substring(4,6) && NPMM == Sch5.substring(7,9) && Sch5.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S5UNIQUE  ){
    ...
    //-----------------------------------
    if (NPMH == Sch6.substring(4,6) && NPMM == Sch6.substring(7,9) && Sch6.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S6UNIQUE  ){
    ...
    if (NPMH == Sch7.substring(4,6) && NPMM == Sch7.substring(7,9) && Sch7.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S7UNIQUE  ){
    ...
    if (NPMH == Sch8.substring(4,6) && NPMM == Sch8.substring(7,9) && Sch8.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S8UNIQUE  ){
    ...
    if (NPMH == Sch9.substring(4,6) && NPMM == Sch9.substring(7,9) && Sch9.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S9UNIQUE  ){
 ...
 //-----------------------------------
    ...
    if (NPMH == Sch10.substring(4,6) && NPMM == Sch10.substring(7,9) && Sch10.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S10UNIQUE  ){
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch11.substring(4,6) && NPMM == Sch11.substring(7,9) && Sch11.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S11UNIQUE  ){
  ...
  //-----------------------------------
    ...
    if (NPMH == Sch12.substring(4,6) && NPMM == Sch12.substring(7,9) && Sch12.substring(9).indexOf(NPWD) >= 0 && NTPUNIQUE != S12UNIQUE  ){
